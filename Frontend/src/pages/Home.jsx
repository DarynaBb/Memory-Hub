...
const onClickHandler = () => {
  ...
  return (
    <section className="max-container">
      <div className="hero-mobile hero-bg relative bg-no-repeat bg-cover bg-center lg:bg-fixed px-[10px] md:pl-[40px] pt-[50px] flex flex-col gap-[20px] md:gap-[40px] pb-[60px]">
